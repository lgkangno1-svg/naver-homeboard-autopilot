...
This applies to every primary agent, subagent, reviewer, investigator, planner, scout, repair/retry worker, fallback, background task, and unattended/automatic loop. All Kimi-family models, DeepSeek Pro-tier models, MiMo Pro-tier models, Luna-tier models, and every other OpenCode Go model are forbidden for these loops.

...
This applies to every primary agent, subagent, reviewer, investigator, planner, scout, repair/retry worker, fallback, background task, and unattended/automatic loop. Kimi models, `deepseek-v4-flash`, `deepseek-v4-flash`, GPT Luna, and every other OpenCode Go model are forbidden for these loops.
